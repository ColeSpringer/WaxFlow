...
func TestPlanOptsCoverage(t *testing.T) {
	...
	populated := TranscodeOptions{
		Format: "x", Container: "x", SpliceTrims: true, Rate: 1, Channels: 1, BitDepth: 1,
		GainDB: 1, Dynamics: gain.PresetVoice, FLACLevel: 1, WavPackLevel: 1, APELevel: 1, MP3Bitrate: 1, MP3VBR: true,
