// Package apen demuxes native Monkey's Audio framing: the descriptor, format
// header, and mandatory seek table a .ape file opens with, the run of frames
// behind them, and the APEv2 tag most files carry after the audio.
//
...
// makes a file whose table is unusable undecodable rather than degraded.
//
