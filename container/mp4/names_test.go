...
func buildMovie(entry []byte, unitBytes, frames, chunkFrames int) []byte {
	...
	stbl := makeBox("stbl",
		...
		makeFullBox("stts", 0, 0, u32(1), u32(uint32(frames)), u32(1)),
		...
		makeFullBox("stsz", 0, 0, u32(uint32(unitBytes)), u32(uint32(frames))),
	...
	mdia := makeBox("mdia",
		makeFullBox("mdhd", 0, 0, u32(0), u32(0),
			u32(movieTimescale), u32(uint32(frames)), u16(0x55C4), u16(0)),
		makeFullBox("hdlr", 0, 0, u32(0), []byte("soun"), make([]byte, 12), []byte{0}),
		minf)
	trak := makeBox("trak",
		makeFullBox("tkhd", 0, 7, u32(0), u32(0), u32(1), u32(0),
			u32(uint32(frames)), make([]byte, 8), u16(0), u16(0), u16(0x0100), u16(0),
			unityMatrix(), u32(0), u32(0)),
		mdia)
	moov := makeBox("moov",
		makeFullBox("mvhd", 0, 0, u32(0), u32(0), u32(movieTimescale),
			u32(uint32(frames)), u32(0x00010000), u16(0x0100), u16(0),
