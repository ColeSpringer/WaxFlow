...
goldens:
	go test -run TestGolden ./container/riff ./container/aiff ./container/flacn ./container/mpa \
		./container/mka ./container/mp4 ./container/ogg ./container/wv ./container/apen ./container/adts -update
